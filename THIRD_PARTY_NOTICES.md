...
| OpenStreetMap source and derived geographic database | `design-review/sannenzaka/source.osm.xml.gz`, `dist/assets/sannenzaka/map.json`; geographic records embedded in composition files | © OpenStreetMap contributors, ODbL 1.0 |
...
distinct from the geographic placements.
